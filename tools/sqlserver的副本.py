...
if __name__ == "__main__":
    ...
    insert_time = getTime()
    res = dbObject.insert(table='superStar',name='larry',age='',
                          insert_time=insert_time,description=description)
    print(res)

    # time.sleep(2)
    # insert_time = getTime()
    # res = dbObject.insert(table='superStar', name='刘亦菲',age='',
    #                       insert_time=insert_time,
    #                       description="I'm very cute,right?")
    # print(res)
    ...
    time.sleep(1)
    insert_time = getTime()
    res = dbObject.insert(table='superStar', name='刘若英', age='',
                          insert_time=insert_time,
